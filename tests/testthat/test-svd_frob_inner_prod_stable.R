...
test_that("svd_frob_inner_prod_stable", {
  ...
  frob_impl <- svd_frob_inner_prod_stable_impl(s_A$u, s_A$d, s_A$v, s_B$u, s_B$d, s_B$v)
  ...
  norm_impl <- svd_frob_inner_prod_stable_impl(s_A$u, s_A$d, s_A$v, s_A$u, s_A$d, s_A$v)
  ...
  impl_diff <- svd_frob_inner_prod_stable_impl(s_A$u, s_A$d, s_A$v, s_A$u, s_A$d, s_A$v) +
    svd_frob_inner_prod_stable_impl(s_B$u, s_B$d, s_B$v, s_B$u, s_B$d, s_B$v) - 2 *
    svd_frob_inner_prod_stable_impl(s_A$u, s_A$d, s_A$v, s_B$u, s_B$d, s_B$v)
